...
export const ASSET_MANIFEST: AssetRecord[] = [
  ...
  {
    assetId: 'A-140', label: '梦境调查碎片素材', kind: 'background',
    pageIds: ['menu-title'], batchIds: ['B7'], status: 'available', directToAi: true,
    provenance: '由图像生成流程产出，用于菜单全页调查碎片、胶片与信号残留层。',
    checksum: 'dream-investigation-fragments-0001', src: '/games/menu/dream-investigation-fragments.png',
    fallback: { kind: 'background', label: '调查碎片缺失', note: '碎片缺失时保留放射线、节点和菜单结构，不用其他图像冒充。' },
  },
  {
