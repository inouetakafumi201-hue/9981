# ⚠️ 废弃：底层 API 完备性设计 Spec

> ## 🚫 本文档已废弃（归档为历史草案）
>
> **归档日期**：2026-08-04
> **废弃原因**：与当前内核 Op/Expr/Effect 架构不兼容
>
> ### 架构差异说明
>
> | 维度 | 本文档（废弃） | 当前实现 |
> |---|---|---|
> | **API 风格** | 命令式（~75个函数调用） | 声明式（Op + Effect DSL） |
> | **数据验证** | 手动在每个函数内校验 | 自动 `checkInstantiable` |
> | **不变量检查** | 无 | `InvariantChecker` |
> | **事务机制** | 无 | 原子事务回滚 |
> | **扩展机制** | 函数注册 | `HookDispatcher` Effect 链 |
>
> ### 状态
>
> 本文档描述的设计方向已被否决，请勿在新代码或新文档中引用。
> 当前架构见 [05_底层引擎架构_v2.md](../05_底层引擎架构_v2.md)
>
> ---
>
> **原始文档内容如下（保持原样以供历史参考）**：
