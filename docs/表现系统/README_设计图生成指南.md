...
1. **推挡滑块 MVP 3 档** (0/1/2)
   - `+3极限爆发` 仅保留为未来评估文本
   - 选择特效和触发特效保留，MVP 不开放 `+3极限爆发`
...
- 像素前景 + 全息投影背景叠加（D-083，2026-08-19；简笔画为历史基线）
- 正面俯视视图（top-down plan view；平面轮廓+落地阴影，无前脸/侧脸/顶面/斜投影纵深）
