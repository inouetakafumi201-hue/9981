...
| S-08 | `docs/00_主状态板.md`、`docs/L_归档/02_项目全局报告_历史.md` | 进度真相与信任判断（L0.5） |
...
17. WakeUp 默认表现配置应声明闭合的颜色语义角色：红=生命减损/伤害/致命危险，蓝=清醒度/体力/SP及科技/处决机会，黄=感官/注意/警戒，橙=AP/行动消耗及进度，绿=安全/正面/免费与让利，紫=关系约束/局部菜单替换/远程，珊瑚=近战/格斗/攻击性/暴力，青=社交/交流及UGC/创意工坊，灰=冷却/延迟，灰白（奶白）=中性底色与材质基底，且泛化睡眠/入梦/梦境相关的世界观语义（D-066）。
...
20. 商店入口应以青色为主，紫色只表达其条件/菜单替换面，绿色只表达免费、低价或折扣；青色兼承载社交、交流与 UGC/创意工坊的来源与创作物语义，交易/经营信息作为其子面由青色承担；远程瞄准关系使用紫色，近战目标使用珊瑚色，实际生命伤害使用红色（D-066）。
